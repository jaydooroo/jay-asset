...
from market.config import dynamodb_endpoint_url  # noqa: E402
from market.dynamodb_client import dynamodb_resource  # noqa: E402
from performance.config import performance_table_name  # noqa: E402
...
if __name__ == "__main__":
    os.environ.setdefault("PERFORMANCE_TABLE", "jay-asset-performance")
